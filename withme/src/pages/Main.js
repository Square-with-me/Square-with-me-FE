...
const Main = () => {
  ...
  const notUser_is_local = localStorage.getItem("notUser_is_login")
    ...
    : false;
  function Not(){
    window.alert("비회원은 로그인 후에 이용 가능 합니다.")
  }
  function NotLog(){
      ...
      <Wrap>
        ...
        <MenuBar className="menulist">
          ...
          <div>          
            ...
            onClick={()=>{dispatch(roomActions.getRoomDB())}}
          /></div>
